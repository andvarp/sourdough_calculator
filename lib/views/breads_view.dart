...
class BreadsView extends StatefulWidget {
  @override
  _BreadsViewState createState() => _BreadsViewState();
}

class _BreadsViewState extends State<BreadsView> {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: <Widget>[
          ...
          RaisedButton(
            onPressed: () {
              _provider.safeToLocalStorage();
            },
            child:
                const Text('Save to the phone', style: TextStyle(fontSize: 20)),
          ),
        ],
      ),
    );
